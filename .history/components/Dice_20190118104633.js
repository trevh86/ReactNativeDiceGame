  ...
  Roll = () => {
    switch (this.Math()) {
      case 1:
        ...
        return rolledDice.push(this.Dice[0]);
      case 2:
        this.state.rolledDice.push = Dice[1];
        return rolledDice.push(this.Dice[1]);
      case 3:
        this.state.rolledDice.push = Dice[2];
        return rolledDice.push(this.Dice[2]);
      case 4:
        this.state.rolledDice.push = Dice[3];
        return rolledDice.push(this.Dice[3]);
      case 5:
        this.state.rolledDice.push = Dice[4];
        return rolledDice.push(this.Dice[4]);
      case 6:
        this.state.rolledDice.push = Dice[5];
        return rolledDice.push(this.Dice[5]);
      default:
